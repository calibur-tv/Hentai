<?php
namespace App\Services\OpenSearch\Generated\FirstRank;
/**
...
interface FirstRankServiceIf {
   ...
   */
  public function save(\App\Services\OpenSearch\Generated\FirstRank\FirstRank $firstRank);
  /**
...
class FirstRankServiceClient implements \App\Services\OpenSearch\Generated\FirstRank\FirstRankServiceIf {
  ...
  public function send_save(\App\Services\OpenSearch\Generated\FirstRank\FirstRank $firstRank)
  {
    $args = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_save_args();
  ...
  public function recv_save()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_save_result();
  ...
  {
    $args = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_getById_args();
  ...
  public function recv_getById()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_getById_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_listAll_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_listAll()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_listAll_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_listByAppId_args();
    $args->appId = $appId;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_listByAppId()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_listByAppId_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_listByAppIdAndName_args();
    $args->appId = $appId;
    $args->name = $name;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  public function recv_listByAppIdAndName()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_listByAppIdAndName_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function recv_updateById()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_updateById_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function recv_validateUpdateById()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_validateUpdateById_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_removeById_args();
    $args->identity = $identity;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_removeById()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\FirstRank\FirstRankService_removeById_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
...
class FirstRankService_save_args {
  ...
  /**
   * @var \App\Services\OpenSearch\Generated\FirstRank\FirstRank
   */
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->firstRank = new \App\Services\OpenSearch\Generated\FirstRank\FirstRank();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \App\Services\OpenSearch\Generated\FirstRank\FirstRank();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \App\Services\OpenSearch\Generated\FirstRank\FirstRank();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \App\Services\OpenSearch\Generated\FirstRank\FirstRank();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem26 = null;
              $elem26 = new \App\Services\OpenSearch\Generated\FirstRank\FirstRank();
