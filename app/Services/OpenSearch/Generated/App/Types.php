      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::MAP) {
            ...
            {
              $key12 = '';
              $val13 = new \App\Services\OpenSearch\Generated\App\Field();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::MAP) {
            ...
            {
              $key28 = '';
              $val29 = new \App\Services\OpenSearch\Generated\App\SearchField();
...
class Schema {
  ...
  public $tables = null;
  /**
   * @var \App\Services\OpenSearch\Generated\App\Indexes
   */
  public $indexes = null;
  /**
   * @var string
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::MAP) {
            ...
            {
              $key44 = '';
              $val45 = new \App\Services\OpenSearch\Generated\App\Table();
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->indexes = new \App\Services\OpenSearch\Generated\App\Indexes();
...
class App {
  ...
  public $type = "advance";
  /**
   * @var \App\Services\OpenSearch\Generated\App\Schema
   */
  public $schema = null;
  /**
   * @var \App\Services\OpenSearch\Generated\App\Quota
   */
  public $quota = null;
  /**
   * @var string
  ...
  /**
   * @var \App\Services\OpenSearch\Generated\App\Group
   */
  public $group = null;
  /**
   * @var bool
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 12:
          if ($ftype == TType::STRUCT) {
            $this->schema = new \App\Services\OpenSearch\Generated\App\Schema();
        ...
        case 13:
          if ($ftype == TType::STRUCT) {
            $this->quota = new \App\Services\OpenSearch\Generated\App\Quota();
        ...
        case 15:
          if ($ftype == TType::STRUCT) {
            $this->group = new \App\Services\OpenSearch\Generated\App\Group();
        ...
        case 19:
          if ($ftype == TType::MAP) {
            ...
            {
              $key66 = '';
              $val67 = new \App\Services\OpenSearch\Generated\FirstRank\FirstRank();
