<?php
namespace App\Services\OpenSearch\Generated\Summary;
/**
...
interface SummaryServiceIf {
   ...
   * @param string $appId
   * @param string $group
   * @return \App\Services\OpenSearch\Generated\Summary\Summary[]
...
class SummaryServiceClient implements \App\Services\OpenSearch\Generated\Summary\SummaryServiceIf {
  ...
  {
    $args = new \App\Services\OpenSearch\Generated\Summary\SummaryService_listByAppIdAndGroup_args();
    $args->appId = $appId;
    $args->group = $group;
  ...
  public function recv_listByAppIdAndGroup()
  {
    ...
    else
    {
      ...
      $result = new \App\Services\OpenSearch\Generated\Summary\SummaryService_listByAppIdAndGroup_result();
...
class SummaryService_listByAppIdAndGroup_result {
  ...
  /**
   * @var \App\Services\OpenSearch\Generated\Summary\Summary[]
   */
  public $success = null;
  /**
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \App\Services\OpenSearch\Generated\Summary\Summary();
